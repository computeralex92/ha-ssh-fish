...
Adjusted to use fish shell and neovim, with additional tools: screen, ncdu, tcpdump,
mtr, rsync, wget, htop, bottom, tmux, git, mosquitto-clients, and more.
...
This project uses [OpenCode](https://opencode.ai) as an AI-assisted development tool
to help with code improvements, security hardening, and configuration optimization.
All changes are reviewed and approved by a human before being merged.
